...
-- Accepts: spellIdentifier, includeHidden, includeFlyouts, includeFutureSpells, includeOffSpec
-- Returns: spellBookItemSlotIndex (luaIndex), spellBookItemSpellBank (SpellBookSpellBank)
...
function Spell:BookIndex()
  ...
  if not BookIndex then
    BookIndex = FindBookIndex(SpellID)
